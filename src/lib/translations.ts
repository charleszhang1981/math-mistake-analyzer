...
export const translations = {
    en: {
        ...
        editor: {
            ...
            standardSolution: "G Standard Solution",
            standardAnswer: "Standard Answer",
            solutionSteps: "Step-by-Step Solution",
            solutionStepsPlaceholder: "One step per line",
            errorLocalization: "H Error Localization",
            studentSteps: "Student Steps",
            wrongStepIndex: "Wrong Step Index (1-based)",
            whyWrong: "Why Wrong",
            fixSuggestion: "How to Fix",
            selfDiagnosis: "I Root-Cause Self Diagnosis",
            startSelfDiagnosis: "Start Self Diagnosis",
            finalRootCause: "Final Root Cause (Confirmed)",
            finalRootCausePlaceholder: "Summarize the confirmed root cause",
            systemHintTitle: "System Hint (Think by yourself first, then click below)",
            showSystemHint: "Click to show system hint",
            noSystemHint: "No system hint available",
            copyHintToTop: "Copy to upper input",
            chatDraft: "Draft from guided chat",
            applyDraft: "Use Draft as Final Cause",
            chatCoachTitle: "Root-Cause Coach",
            chatCoachDesc: "Guided questions only. Internal diagnosis candidates are hidden.",
            chatEmptyHint: "Start by describing your solving process in 2-3 steps.",
            chatPlaceholder: "Write your current root-cause hypothesis",
            chatCoach: "Coach",
            chatStudent: "Student",
            send: "Send",
        },
    ...
    zh: {
        ...
        editor: {
            ...
            standardSolution: "G 标准解法",
            standardAnswer: "标准答案",
            solutionSteps: "分步解法",
            solutionStepsPlaceholder: "每行一步",
            errorLocalization: "H 错误定位",
            studentSteps: "学生步骤",
            wrongStepIndex: "错误步骤序号（从1开始）",
            whyWrong: "为什么错",
            fixSuggestion: "如何改",
            selfDiagnosis: "I 根因自诊断",
            startSelfDiagnosis: "开始自我诊断",
            finalRootCause: "最终根因（确认）",
            finalRootCausePlaceholder: "总结确认后的根因",
            systemHintTitle: "\u7cfb\u7edf\u63d0\u793a\uff08\u8bf7\u5148\u81ea\u5df1\u601d\u8003\uff0c\u7136\u540e\u518d\u70b9\u51fb\u4e0b\u65b9\u6309\u94ae\uff09",
            showSystemHint: "\u70b9\u51fb\u663e\u793a\u7cfb\u7edf\u63d0\u793a",
            noSystemHint: "\u6682\u65e0\u7cfb\u7edf\u63d0\u793a",
            copyHintToTop: "\u590d\u5236\u5230\u4e0a\u65b9\u8f93\u5165",
            chatDraft: "对话生成草稿",
            applyDraft: "用草稿填入最终根因",
            chatCoachTitle: "根因教练",
            chatCoachDesc: "仅展示引导问题，不显示内部候选根因。",
            chatEmptyHint: "先用2-3步描述你是怎么做这道题的。",
            chatPlaceholder: "写下你当前的根因假设",
            chatCoach: "教练",
            chatStudent: "学生",
            send: "发送",
        },
